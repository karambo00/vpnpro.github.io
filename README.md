...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="subsection">
                <p><strong>11.2.</strong> Оператор вправе изменять Политику в одностороннем порядке. Актуальная редакция вступает в силу с момента её размещения на сайте <a href="https://ogonvpn.xyz">https://ogonvpn.xyz</a>.</p>
            </div>
